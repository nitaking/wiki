...
export const creators: Creator[] = [
  ...
  // },
  {
    // nitaking, Satoshi Nitawaki
    name: 'Satoshi Nitawaki',
    avatar: '',
    username: 'nitaking',
    title: '',
    desc: 'Full-stack developer, focusing on web development, DevOps, and cloud-native architecture',
    links: [
      { type: 'github', icon: 'github', link: 'https://github.com/nitaking' },
      { type: 'twitter', icon: 'twitter', link: 'https://twitter.com/nitaking_' },
    ],
    nameAliases: ['nitaking', 'Satoshi Nitawaki'],
  },
].map<Creator>((c) => {
